      ...
      <div className="container relative">
        ...
        <AnimatedSection delay={0.3} className="mt-14">
          <div className="rounded-2xl overflow-hidden border border-border/60" style={{ boxShadow: '0 4px 24px -6px rgba(0,0,0,0.06)' }}>
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3767.0!2d72.8!3d19.4!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2sElite+Forums!5e0!3m2!1sen!2sin!4v1700000000000"
              width="100%"
              height="320"
              style={{ border: 0 }}
              allowFullScreen
