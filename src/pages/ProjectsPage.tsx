...
const ProjectsPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Our Projects | Elite Forums</title>
        <meta
          name="description"
          content="Explore Elite Forums' portfolio of successful digital solutions delivered for clients across industries."
        />
      </Helmet>
            ...
            <div className="container relative">
              <AnimatedSection className="text-center mb-16">
                ...
                <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
                  Showcasing our portfolio of successful digital solutions delivered for clients across industries.
                </p>
              </AnimatedSection>
